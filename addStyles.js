const bodyClass = "bg-black-800 bg-gradient-to-br from-black-300 bg-opacity-25";
const bdy = document.querySelector("body");
bodyClass.split(" ").forEach((cls) => bdy.classList.add(cls));

const calcBodyClass =
  "max-w-lg rounded overflow-hidden shadow-2xl bg-black bg-opacity-75 bg-gradient-to-tr from-gray-800 flex";
...
function addClasses(button) {
  const btnNumberClass = "hover:bg-yellow-500 border-yellow-500";
  ...
  const btnDecClass = "hover:bg-violet-500 border-violet-500";
